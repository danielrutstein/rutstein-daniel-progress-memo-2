...
draft |>
  ...
  geom_point()
```
Looks like an exponential regression to me. Let's normalize our w_av variable by an exponential approximation to minimize the affect of year possible as much as we can.
